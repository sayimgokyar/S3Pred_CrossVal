This file contains the definitons of the data for a fictitious participants called Sub00. All the other subject folders use the same convention for naming and data definitions.
  ...
  4- Sub00Run01_iteration001.SAR: This is the ground truth data for the given RF shim settings. This data is calculated by using Sim4Life (by zmt.swiss) software and generic pTx RF coils. Details are reported in the original manuscript.
...
h5create(filename, '/ds', imageresolution,'Datatype','single'); 
h5write(filename, '/ds', Data_ROI);

The above data can be read by using the following python comands:
